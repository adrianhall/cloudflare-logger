/**
 * @file Tests for `src/defensive-guards.ts`.
 *
 * Covers:
 *  - `optionalField` returns `{ [prop]: value }` when the property is present
 *    and non-`undefined`.
 *  - `optionalField` returns `{}` when the property value is `undefined`.
 *  - `optionalField` returns `{}` when the property is absent from the object.
 */

import { describe, expect, it } from "vitest";
import * as sut from "../../src/defensive-guards.js";
