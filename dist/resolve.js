 ...
 */
export function resolveLoggerConfig(environment, runtime) {
    // Normalise: anything that is not a recognised well-known string falls
    // through to the production defaults.
