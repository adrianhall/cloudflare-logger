 ...
 *
 * Typed as `(...args: unknown[]) => void` so that both the real `console`
 * object and test-injected spies satisfy the shape without needing to reference
 ...
 *
 * Transports accept an optional `console` parameter (defaulting to the global
 * `console`) so that tests can inject a spy without patching the global.
 */
 ...
 */
export declare function getConsoleMethod(c: ConsoleLike, method: ConsoleMethodName): ConsoleMethod;
